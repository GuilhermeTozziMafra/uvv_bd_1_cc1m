...
COMMENT ON TABLE uvv.funcionario IS 'Tabela que armazena as informações dos funcionários.';
COMMENT ON COLUMN uvv.funcionario.cpf IS 'CPF do funcionário. Será a PK da tabela.';
COMMENT ON COLUMN uvv.funcionario.primeiro_nome IS 'Primeiro nome do funcionário.';
COMMENT ON COLUMN uvv.funcionario.nome_meio IS 'Inicial do nome do meio.';
COMMENT ON COLUMN uvv.funcionario.ultimo_nome IS 'Sobrenome do funcionário.';
COMMENT ON COLUMN uvv.funcionario.data_nascimento IS 'Criação da coluna data_nascimento da tabela funcionario.';
COMMENT ON COLUMN uvv.funcionario.endereco IS 'Endereço do funcionário.';
COMMENT ON COLUMN uvv.funcionario.sexo IS 'Sexo do funcionário.';
COMMENT ON COLUMN uvv.funcionario.salario IS 'Salário do funcionário.';
COMMENT ON COLUMN uvv.funcionario.cpf_supervisor IS 'CPF do supervisor. Será uma FK para a própria tabela (um auto-relacionamento).';
COMMENT ON COLUMN uvv.funcionario.numero_departamento IS 'Número do departamento do funcionário.';
...
COMMENT ON TABLE uvv.departamento IS 'Tabela que armazena as informações dos departamentos.';
COMMENT ON COLUMN uvv.departamento.numero_departamento IS 'Número do departamento. É a PK desta tabela.';
COMMENT ON COLUMN uvv.departamento.nome_departamento IS 'Nome do departamento. Deve ser único.';
COMMENT ON COLUMN uvv.departamento.cpf_gerente IS 'CPF do gerente do departamento. É uma FK para a tabela funcionários.';
COMMENT ON COLUMN uvv.departamento.data_inicio_gerente IS 'Data do início do gerente no departamento.';
...
COMMENT ON TABLE uvv.projeto IS 'Tabela que armazena as informações sobre os projetos dos departamentos.';
COMMENT ON COLUMN uvv.projeto.numero_projeto IS 'Número do projeto. É a PK desta tabela.';
COMMENT ON COLUMN uvv.projeto.nome_projeto IS 'Nome do projeto. Deve ser único';
COMMENT ON COLUMN uvv.projeto.local_projeto IS 'Localização do projeto.';
COMMENT ON COLUMN uvv.projeto.numero_departamento IS 'Número de departamento. É uma FK para a tabela departamento.';
...
COMMENT ON TABLE uvv.trabalha_em IS 'Tabela para armazenar quais funcionários trabalham em quais projetos.';
COMMENT ON COLUMN uvv.trabalha_em.cpf_funcionario IS 'CPF do funcionário. Faz a parte da PK desta tabela e é uma FK para a tabela funcionário.';
COMMENT ON COLUMN uvv.trabalha_em.numero_projeto IS 'Número do projeto. Faz parte da PK desta tabela e é uma FK para a tabela projeto.';
COMMENT ON COLUMN uvv.trabalha_em.horas IS 'Horas trabalhadas pelo funcionário neste projeto';
...
COMMENT ON TABLE uvv.localizacoes_departamento IS 'Tabela que armazena as possíveis localizações dos departamentos.';
COMMENT ON COLUMN uvv.localizacoes_departamento.numero_departamento IS 'número do departamento. Faz parte da PK desta tabela e também é uma FK para a tabela departamento.';
COMMENT ON COLUMN uvv.localizacoes_departamento.local IS 'Localização do departamento. Faz parte da PK desta tabela.';
...
COMMENT ON TABLE uvv.dependente IS 'Tabela que armazena as informações dos dependetes das funcionários.';
COMMENT ON COLUMN uvv.dependente.cpf_funcionario IS 'CPF do funcionário. Faz parte da PK desta tabela e é uma FK para a tabela funcionário.';
COMMENT ON COLUMN uvv.dependente.nome_dependente IS 'Nome do dependente. Faz parte da PK desta tabela.';
COMMENT ON COLUMN uvv.dependente.sexo IS 'Sexo do dependente.';
COMMENT ON COLUMN uvv.dependente.data_nascimento IS 'Data de nascimento do dependente.';
COMMENT ON COLUMN uvv.dependente.parentesco IS 'Descrição do parentesco do dependente com o funcionário.';
...
ALTER TABLE uvv.localizacoes_departamento ADD CONSTRAINT numero_departamento_localizacoes_departamento_fk
